<template>
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-cool-grey-200">
            <div>
            ...
            <div class="mt-6 text-cool-grey-500">
                Laravel Jetstream provides a BUTTS, robust starting point for
        ...
        <div
            class="
                bg-cool-grey-200 bg-opacity-25
                grid grid-cols-1
                md:grid-cols-2
            "
        >
            <div class="p-6">
                <div class="flex items-center">
                    <svg
                        ...
                        stroke-width="2"
                        viewBox="0 0 24 24"
                        class="w-8 h-8 text-cool-grey-400"
                    >
                        <path
                ...
                <div class="ml-12">
                    <div class="mt-2 text-sm text-cool-grey-500">
            ...
            <div class="p-6 border-t border-cool-grey-200">
                <div class="flex items-center">
                    <svg
                        fill="none"
                        stroke="currentColor"
            ...
            <div class="p-6 border-t border-cool-grey-200 md:border-l">
                <div class="flex items-center">
                    <svg
                        fill="none"
                        stroke="currentColor"
