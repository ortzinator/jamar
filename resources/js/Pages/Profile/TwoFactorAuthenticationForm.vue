<template>
    <jet-action-section>
        ...
        <template #content>
            ...
            <h3 class="text-lg font-medium text-cool-grey-900" v-else>
                You have not enabled two factor authentication.
            </h3>

            <div class="mt-3 max-w-xl text-sm text-cool-grey-600">
                <p>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-cool-grey-600">
