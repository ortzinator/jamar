<template>
  ...
  <svg v-else-if="name === 'trash'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" /></svg>
  ...
  <svg v-else-if="name === 'spinner'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 0C4.47.005 0 4.48 0 10s4.48 10 10 10c4.37 0 8.08-2.81 9.44-6.72l-2.36-.818c-1.02 2.93-3.8 5.04-7.08 5.04-4.14 0-7.5-3.36-7.5-7.5 0-4.13 3.35-7.49 7.5-7.5 3.29-.008 6.07 2.11 7.08 5.05l2.36-.816c-1.35-3.92-5.06-6.74-9.44-6.73z"/></svg>
  <svg v-else-if="name === 'plus-circle'" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
</template>
